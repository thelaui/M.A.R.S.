...
UiWindow* MainMenu::get() {
    if (instance_ == NULL) {
        instance_ = new MainMenu(180, 190, Vector2f(0.f, 50.f));
        instance_->addWidget(new Button("Start Local Game",   &kStartLocal_,  Vector2f(10,10),  160, 20));
        instance_->addWidget(new Button("Start Network Game", &kStartMulti_,  Vector2f(10,40),  160, 20));
        instance_->addWidget(new Button("Join Network Game",  &kJoinMulti_,   Vector2f(10,70),  160, 20));
        instance_->addWidget(new Button("Options",            &kOptions_,     Vector2f(10,100), 160, 20));
        instance_->addWidget(new Button("About",              &kAbout_,       Vector2f(10,130), 160, 20));
        instance_->addWidget(new Button("Quit M.A.R.S.",      &kExit_,        Vector2f(10,160), 160, 20));
    }
    return instance_;
}
