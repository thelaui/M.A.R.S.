...
UiWindow* InfoDM::get() {
    if (instance_ == NULL) {
        ...
        instance_->addWidget(new Label(new std::string("DeathMatch"), TEXT_ALIGN_LEFT, Vector2f(10,10), 20.f));
        ...
        instance_->addWidget(new Checkbox(locales::getLocale(locales::ShowAgainButton), &settings::C_showInfoDM, Vector2f(10,400), 170));
    }
    return instance_;
}
