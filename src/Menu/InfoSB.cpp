...
UiWindow* InfoSB::get() {
    if (instance_ == NULL) {
        ...
        instance_->addWidget(new Label("Kick or shoot the ball to your enemy's planet!", TEXT_ALIGN_LEFT, Vector2f(10,50), 12.f, Color3f(1.f, 0.7f, 0.9f)));
        ...
        instance_->addWidget(new Checkbox("Show this info again.", &settings::C_showInfoSB, Vector2f(10,400), 170));
    }
    return instance_;
}
