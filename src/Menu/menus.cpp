...
namespace menus {
    ...
    void draw() {
        if (visible() && !hidden_) {
            ...
            text::drawScreenText("M.A.R.S. 0.6.1 - " + sf::String(__DATE__), Vector2f(viewPort.x_-4.f, viewPort.y_-14.f) , font::HandelGotDLig, 11.f, TEXT_ALIGN_RIGHT, Color3f(0.8, 0.8, 0.8));
        }
    }
