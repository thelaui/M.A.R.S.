...
UiWindow* EnterName::get() {
    if (instance_ == NULL) {
        ...
        instance_->addWidget(new TextEdit(NULL, &settings::C_playerIName, "PlayerI", Vector2f(10,85), 300, 0, TEXT_EDIT, 12));
		  ...
		  instance_->addWidget(new Label(locales::format_string(_("Hey, %s"), locales::get_string(settings::C_playerIName)), TEXT_ALIGN_LEFT, Vector2f(10,10), 20.f, Color3f(1.f, 0.5f, 0.9f), false));
