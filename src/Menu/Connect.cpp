...
UiWindow* Connect::get() {
    if (instance_ == NULL) {
        ...
        instance_->addWidget(new Button(locales::getLocale(locales::Close), NULL, &kClose_, Vector2f(240,150), 70, 20));
        ...
        instance_->addWidget(new TextBox(locales::getLocale(locales::JoinNetworkText), Vector2f(10, 50), 300, 90));
    }
    return instance_;
}
