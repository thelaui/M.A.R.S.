...
UiWindow* OptionsMenu::get() {
    if (instance_ == NULL) {
        ...
        tabGameplay->addWidget(new Slider(locales::getLocale(locales::GameSpeed), locales::getLocale(locales::ttGameSpeed), &settings::C_gameSpeed, 0, 2, 1, Vector2f(20,80), 540, 240, true));
