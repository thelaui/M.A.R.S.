...
namespace numbers {
    ...
    void Number::draw() const {
        ...
        sstr << value_;
        if (value_ > 0)
            text::drawSpaceText(sstr.str(), *sourceLocation_ - Vector2f(0.0f, 40.f) - Vector2f(0.f, 20.f)*lifeTime_, font::Ubuntu, 20.f, TEXT_ALIGN_CENTER, color_);
        else
            text::drawSpaceText(sstr.str(), *sourceLocation_ + Vector2f(0.f, 20.f)*lifeTime_, font::Ubuntu, 20.f, TEXT_ALIGN_CENTER, color_);
    }
